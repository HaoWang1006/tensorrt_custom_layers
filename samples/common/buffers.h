  ...
  public:
    ...
    size_t nbBytes() const
    {
      std::cout << "this->size() === " << this->size() << " "
                << samplesCommon::getElementSize(mType) << std::endl;
